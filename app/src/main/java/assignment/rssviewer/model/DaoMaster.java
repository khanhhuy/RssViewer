...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        SuggestionCategoryDao.createTable(db, ifNotExists);
        SuggestionSourceDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        SuggestionCategoryDao.dropTable(db, ifExists);
        SuggestionSourceDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(SuggestionCategoryDao.class);
        registerDaoClass(SuggestionSourceDao.class);
    }
