...
public class ArticleDao extends AbstractDao<Article, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UrlString = new Property(5, String.class, "urlString", false, "URL_STRING");
        public final static Property ImageUrl = new Property(6, String.class, "imageUrl", false, "IMAGE_URL");
        public final static Property RssSourceId = new Property(7, long.class, "rssSourceId", false, "RSS_SOURCE_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ARTICLE' (" + //
                ...
                "'URL_STRING' TEXT," + // 5: urlString
                "'IMAGE_URL' TEXT," + // 6: imageUrl
                "'RSS_SOURCE_ID' INTEGER NOT NULL );"); // 7: rssSourceId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Article entity) {
        ...
        stmt.bindLong(8, entity.getRssSourceId());
    }
    ...
    public Article readEntity(Cursor cursor, int offset) {
        Article entity = new Article( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // urlString
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // imageUrl
            cursor.getLong(offset + 7) // rssSourceId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Article entity, int offset) {
        ...
        entity.setUrlString(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setImageUrl(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setRssSourceId(cursor.getLong(offset + 7));
     }
